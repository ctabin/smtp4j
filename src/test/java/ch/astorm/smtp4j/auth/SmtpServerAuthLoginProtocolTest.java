...
public class SmtpServerAuthLoginProtocolTest {
    @Test
    ...
    @Test
    public void testLoginAuthenticationWithStartssl() throws Exception {
        SmtpServerBuilder builder = new SmtpServerBuilder();
        try(SmtpServer smtpServer = builder.
            withAuthenticator(LoginAuthenticationHandler.INSTANCE).
            withUser("jdoe", "bE5HxNrCL7,:3=yP@vta6n").
    ...
    @Test
    public void testLoginAuthenticationWithSMTPS() throws Exception {
        SmtpServerBuilder builder = new SmtpServerBuilder();
        try(SmtpServer smtpServer = builder.
            withAuthenticator(LoginAuthenticationHandler.INSTANCE).
            withUser("jdoe", "bE5HxNrCL7,:3=yP@vta6n").
